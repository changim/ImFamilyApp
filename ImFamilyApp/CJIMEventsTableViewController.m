//
//  CJIMEventsTableViewController.m
//  ImFamilyApp
//
...
@interface CJIMEventsTableViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation CJIMEventsTableViewController
...
{
    [self performSegueWithIdentifier:@"showNewEvent" sender:self];
}
